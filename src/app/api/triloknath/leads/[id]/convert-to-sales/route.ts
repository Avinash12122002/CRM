...
// handed off to a Case Manager (least-loaded case_manager user is picked).
// Every step is recorded in the lead's history for audit purposes.
export async function POST(
  ...
  try {
    ...
    if (caseManagerIdRaw) {
      ...
      // Auto-pick the least-loaded case manager across both collections
    ...
    try {
      ...
      await createNotification({
        ...
        title: "New Case Lead",
        message: `Triloknath Lead ${lead.name || `#${leadId}`} was converted to Sales and assigned to you for Case Marketing.`,
        type: "lead_assigned",
