...
// Streams the signed document attached to a Triloknath lead when it was
// converted to "sales". Access is restricted to: the admin, the case manager
// it is currently assigned to, and whoever uploaded the file.
