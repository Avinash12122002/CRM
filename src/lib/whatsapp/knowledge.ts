 ...
 * Australia Subclass 482 (Temporary Skill Shortage / Skills in Demand) Work Visa
 */
...
- CRITICAL WHATSAPP MESSAGE LENGTH & ZERO CUT-OFF RULE (MAX 500 CHARACTERS):
  * Target length: UNDER 500 CHARACTERS (roughly 60 to 80 words).
  * NEVER truncate or cut off mid-sentence. Always finish your sentence, thought, and call-to-action completely!
  * Deliver the complete, accurate core information concisely without conversational filler.
  * Recommended structure:
    1. Friendly, direct 1-sentence answer.
    2. 2-3 short bullet points with key numbers/facts (e.g. AUD $76,500, AUD 300 + 700, 4-5 months, 691 occupations).
    3. 1 short closing question or call-to-action.
...
export const FAQ_FALLBACKS: Array<{ keywords: string[]; answer: string }> = [
  ...
  },
  {
    ...
    answer:
      "Here is our complete Australia Subclass 482 explainer video! 🎥🇦🇺\n\n" +
  ...
  },
  {
    ...
    answer:
      "TMS Visa specializes **exclusively in Australian Subclass 482 Work Visas**! 🇦🇺\n\n" +
  ...
  },
  {
    ...
    answer:
      "TMS Visa specializes **exclusively in employer-sponsored work visas** (Subclass 482) and does not process tourist or student visas. 🇦🇺\n\n" +
  ...
  },
  {
    ...
    answer:
      ...
      "I assist skilled professionals with Australia Subclass 482 Work Visas. I'd love to help you with your Australian career goals! What is your current profession or trade background?",
  },
  {
    ...
    answer:
      ...
      "This includes Australian employer marketing, official nomination approval with the Department of Home Affairs, and visa lodgement.",
  },
  {
    ...
    answer:
      ...
      "• $330 Work Permit + $6,000 Embassy Fees + Flight Ticket\n\n" +
      "👤 **Candidate Total Fee: AUD 1,000** (2 milestones):\n" +
      "1️⃣ **AUD 300 upfront:** Australian CV makeover + weekly PTE classes from Day 1\n" +
  ...
  },
  {
    ...
    answer:
      ...
      "Because Subclass 482 is directly employer-sponsored, we connect your profile with pre-vetted Australian employers who issue government-approved nomination letters. Your dedicated Case Manager manages all documentation ensuring guaranteed compliance.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Subclass 482 requires a basic English score (e.g. PTE Academic min L:33 R:36 W:29 S:24, or IELTS 5.0 in each band) 🇦🇺.\n\n" +
      "📚 **TMS provides free weekly PTE preparation classes from Day 1!** You only sit the exam after securing your employer job offer.\n\n" +
      "Have you taken an English test yet?",
  },
  {
    keywords: ["case manager", "manager", "support", "cv", "resume"],
    answer:
      "Upon joining, you get a **dedicated TMS Case Manager**! 🤝\n\n" +
      "Your Case Manager revamps your CV to Australian market standards, enrolls you in weekly PTE English classes, and coordinates directly with Australian employers so you are fully supported at every step.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Our 4-5 month Australia Subclass 482 process: 🇦🇺\n\n" +
      "1️⃣ **CV Review:** Check eligibility across 691 occupations\n" +
      "2️⃣ **Start (AUD 300):** Australian CV makeover + weekly PTE classes\n" +
      "3️⃣ **Employer Marketing:** TMS secures job offer & nomination\n" +
      "4️⃣ **Visa Lodgement:** File Subclass 482 visa with Dept of Home Affairs\n" +
  ...
  },
  {
    ...
    answer:
      ...
      "• **Initial AUD 300:** Covers immediate work (Australian CV makeover, profile assessment, and weekly PTE classes; non-refundable once work begins).\n" +
