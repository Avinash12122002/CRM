...
export const FAQ_FALLBACKS: Array<{ keywords: string[]; answer: string }> = [
  ...
  },
  {
    ...
    answer:
      "Here is our complete Australia Subclass 482 Skills in Demand explainer video! 🎥🇦🇺\n\n" +
  ...
  },
  {
    ...
    answer:
      ...
      "Because this involves government work permits, official nomination letters, and embassy verification, this timeline is standard and cannot be skipped or rushed.",
  },
  {
    keywords: ["cost", "fee", "fees", "price", "charge", "charges", "payment", "pay", "how much do i pay", "how much is", "how much fee", "how much cost"],
    answer:
      "Our pricing is completely transparent with **no hidden charges**! 🇦🇺\n\n" +
      "💼 **Paid by your Australian Employer:**\n" +
      "• $330 AUD Work Permit\n" +
      "• $6,000 AUD Embassy & Visa Fees\n" +
      "• $1,000 AUD Flight Ticket to Australia\n\n" +
      "👤 **Candidate's Total TMS Service Charge: 1,000 AUD** (split into 2 milestones):\n" +
      "1️⃣ **300 AUD at the start:** covers your dedicated TMS Case Manager, Australian-format professional CV revamp, and weekly PTE English classes.\n" +
      "2️⃣ **Remaining 700 AUD:** paid ONLY after 4-5 months when your visa is approved and flight tickets are in your hand! ✈️\n\n" +
      "Our initial 30-minute Google Meet consultation is **100% free**. Would you like to reserve a slot this weekend?",
  },
  {
    keywords: ["reject", "rejection", "guarantee", "success rate", "refusal", "never rejected"],
    answer:
      "A work visa with TMS **never gets rejected**! 🇦🇺\n\n" +
      "Because the Subclass 482 is an employer-sponsored pathway, we directly connect your skills with Australian employers who issue official nomination letters. Your dedicated TMS Case Manager handles all documentation and compliance with the Department of Home Affairs, ensuring a seamless, guaranteed approval.",
  },
  {
    keywords: ["document", "documents", "paperwork", "pcc", "passport"],
    answer:
      "As a candidate, you only need to arrange **3 documents** from your side:\n\n" +
  ...
  },
  {
    ...
    answer:
      "Right after signing the service agreement, you are assigned a **dedicated TMS Case Manager**! 🤝\n\n" +
      "Your Case Manager guides you through every single step, transforms your basic CV into an Australian job-market standard CV, enrolls you in weekly PTE English classes, and coordinates directly with Australian employers so you are never left alone.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, absolutely! 👨‍👩‍👧‍👦 Your spouse and dependent children can accompany you to Australia:\n\n" +
      "• **Spouse:** Gets **unrestricted full-time work rights** across Australia in any sector.\n" +
      "• **Children:** Can study in Australian public schools (subsidized/free).\n" +
      "• **Permanent Residency:** Direct pathway to PR (Subclass 186) after 2 years of work!",
  },
  {
